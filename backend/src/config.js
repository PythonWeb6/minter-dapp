...
const CHAIN = 'pokygon'; // only goerli, polygon, or ethereum
...
const MINT_PRICE = 5; // Minting price per NFT. Goerli = ETH, Ethereum = ETH, Polygon = MATIC. CANNOT BE UPDATED!
...
const BASE_URI = "ipfs://bafybeigxeaez2errlopq7ow77i7nxozm33abonkheryfegayjpybi6gh44/"; // only update if you want to manually set the base uri
